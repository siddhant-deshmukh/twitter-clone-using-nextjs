...
import CImgs from "../../../TweetEditor/CImages";
import { IMedia } from "../../../../models/Media";
import Axios from "axios"
//{otherTweet}:ITweetEditorProps
const MakeTweet = () => {
    ...
    useEffect(()=>{
      console.log("starting MakeEditor!!!!")
      return ()=>{
        console.log("Closing the MakeEditor")
      }
    },[])
    const handleSelectingMediaBtn_ = useCallback((e : React.ChangeEvent<HTMLInputElement>) => {
      ...
      <div className="flex " style={{ width: 500 }}>
        ...
        <div className="w-full px-1">
          ...
          </div>
          {
            ...
            <CImgs key={"TextEditor"} tweetAttachments={tweetAttachments} setTweetAttachments={setTweetAttachments} />
          }
          <div className="flex border-t justify-between w-full border-blue-100 pt-2" style={{fontSize:"15px"}}>
            <div className="flex items-center">

              <div>
                <input type="file" id="select-media_MakeTweet" onChange={handleSelectingMediaBtn_} accept=".png, .jpg, .gif, .jpeg" hidden/>
                <label className="place-content-center" htmlFor={"select-media_MakeTweet"} >
