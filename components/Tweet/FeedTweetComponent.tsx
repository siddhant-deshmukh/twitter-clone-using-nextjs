    ...
    <div
      ...
      <div className="w-full flex flex-col ">
        ...
        <ul className="flex justify-between text-gray-500">
          <li className="w-full">
            <button className="w-fit items-center flex justify-start  pr-4 py-2  group hover:text-blue-700 tweet-btn">
              ...
              <span className="text-blue tweet-btn pl-1">{tweet.num_comments}</span>
            </button>
          </li>
          <li className="w-full">
            <button
              className={`w-fit ${(tweet.have_retweeted) ? 'text-green-500' : ''} items-center flex justify-start  pr-4 py-2  group hover:text-green-700 tweet-btn`}
          ...
          <li className="w-full">
            <button
              className={`w-fit ${(tweet.have_liked) ? 'text-red-700' : ''} items-center flex justify-start  pr-4 py-2  group hover:text-red-700 tweet-btn`}
              onClick={(event: React.MouseEvent<HTMLButtonElement>) => {
                event.preventDefault();
                updateTweet('liked')
              }}>
          ...
          <li className="w-full">
            <button
              className="w-fit items-center flex justify-start  pr-4 py-2  group hover:text-blue-700 tweet-btn"
              onClick={(event) => {
                console.log("Here")
